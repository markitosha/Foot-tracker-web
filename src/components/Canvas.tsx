...
export default function Canvas() {
    ...
    return <div className={'flex items-center'}>
        <div className={'relative'}>
            <video src={'https://firebasestorage.googleapis.com/v0/b/pleaz-player-staging.appspot.com/o/282406_half_2_10min.mp4?alt=media&token=a47d6f04-cbaf-4521-a623-9724f5f45738'} className={'w-2/3'} ref={videoRef}/>
